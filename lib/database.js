...
class Database {
	...
	dbToDos = () => {
		return this._instance.collection(Constants.TODOS_COLLECTION); // this function returns the db you're connected to and the collection passed into .collection.  In this case that is whatever is contained in Constant.TODOS_COLLECTION...and that is todos
	}
};
